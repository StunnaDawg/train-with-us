...
CREATE TABLE IF NOT EXISTS "public"."communities" (
    ...
    "about" "text",
    "city" "text" DEFAULT 'Halifax'::"text" NOT NULL,
    "location" "text"
);
...
ALTER TABLE "public"."community_channel_messages" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."community_channel_messages"
    ADD CONSTRAINT "community_channel_messages_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."community_channel_messages"
    ADD CONSTRAINT "public_community_channel_messages_channel_id_fkey" FOREIGN KEY ("channel_id") REFERENCES "public"."community_channels"("id") ON DELETE CASCADE;

ALTER TABLE ONLY "public"."community_channel_messages"
    ADD CONSTRAINT "public_community_channel_messages_sender_id_fkey" FOREIGN KEY ("sender_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."profiles"
    ADD CONSTRAINT "public_profiles_primary_gym_fkey" FOREIGN KEY ("primary_gym") REFERENCES "public"."communities"("id") ON UPDATE CASCADE ON DELETE SET NULL;

ALTER TABLE ONLY "public"."profiles"
    ADD CONSTRAINT "public_profiles_secondary_gym_fkey" FOREIGN KEY ("secondary_gym") REFERENCES "public"."communities"("id") ON UPDATE CASCADE ON DELETE SET NULL;

ALTER TABLE ONLY "public"."user_tokens"
    ADD CONSTRAINT "public_user_tokens_id_fkey" FOREIGN KEY ("id") REFERENCES "public"."profiles"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
CREATE POLICY "Enable delete for users based on user_id" ON "public"."events" FOR DELETE USING ((( SELECT "auth"."uid"() AS "uid") = "event_host"));
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."community_channel_messages" FOR INSERT TO "authenticated" WITH CHECK (true);
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."events_users" FOR INSERT TO "authenticated" WITH CHECK (true);
...
CREATE POLICY "Enable insert for users based on user_id" ON "public"."events" FOR INSERT WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "event_host"));

CREATE POLICY "Enable insert for users based on user_id" ON "public"."user_tokens" FOR INSERT WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "id"));
...
CREATE POLICY "Enable read access for all users" ON "public"."community_channel_messages" FOR SELECT USING (true);
...
CREATE POLICY "Enable read access for all users" ON "public"."events_users" FOR SELECT USING (true);
...
CREATE POLICY "Kick User" ON "public"."community_members" FOR DELETE USING (true);
...
CREATE POLICY "event update" ON "public"."events" FOR UPDATE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "event_host"));

ALTER TABLE "public"."events" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "public"."events_users" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "member update" ON "public"."community_members" FOR UPDATE USING (true);
...
GRANT ALL ON TABLE "public"."community_channel_messages" TO "anon";
GRANT ALL ON TABLE "public"."community_channel_messages" TO "authenticated";
GRANT ALL ON TABLE "public"."community_channel_messages" TO "service_role";
